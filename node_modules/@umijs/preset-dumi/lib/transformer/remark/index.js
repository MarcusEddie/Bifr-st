...
var _default = (source, fileAbsPath, type) => {
  ...
  }).use(debug('comments')).use(_code.default).use(debug('code')).use(_embed.default).use(debug('embed')).use(_api.default).use(debug('api')).use(_slug.default).use(debug('slug')).use(_rehypeAutolinkHeadings().default).use(debug('headings')).use(_link.default).use(debug('link')).use(_img.default).use(debug('img')).use(_previewer.default).use(debug('previewer')).use(_isolation.default).use(debug('isolation')).data('fileAbsPath', fileAbsPath).data('outputType', type); // apply compiler via type
