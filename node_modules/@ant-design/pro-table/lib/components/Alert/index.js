...
function TableAlert(_ref) {
  var selectedRowKeys = _ref.selectedRowKeys,
    ...
    var intl = _ref2.intl;
    return /*#__PURE__*/_react.default.createElement(_antd.Space, null, intl.getMessage('alert.selected', '已选择'), selectedRowKeys.length, intl.getMessage('alert.item', '项'), "\xA0\xA0");
