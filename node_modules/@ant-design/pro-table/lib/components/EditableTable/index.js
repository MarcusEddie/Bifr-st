...
var _excluded = ["onTableChange", "maxLength", "recordCreatorProps", "rowKey", "controlled"],
...
function EditableTable(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    value.forEach(function (current, index) {
      form.setFieldsValue(_defineProperty({}, getRowKey(current, index), current));
  ...
  var creatorButtonDom = (0, _react.useMemo)(function () {
    ...
    return recordCreatorProps !== false && /*#__PURE__*/_react.default.createElement(RecordCreator, {
      record: (0, _proUtils.runFunction)(record, value.length, value) || {},
      position: position,
      parentKey: (0, _proUtils.runFunction)(parentKey, value.length, value),
      newRecordType: newRecordType
  ...
  if ((props === null || props === void 0 ? void 0 : props.onValuesChange) || ((_props$editable = props.editable) === null || _props$editable === void 0 ? void 0 : _props$editable.onValuesChange) || props.controlled && (props === null || props === void 0 ? void 0 : props.onChange)) {
