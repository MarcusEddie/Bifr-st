...
var _excluded = ["rowKey", "tableClassName", "action", "tableColumn", "type", "pagination", "rowSelection", "size", "defaultSize", "tableStyle", "toolbarDom", "searchNode", "style", "cardProps", "alertDom", "onSortChange", "onFilterChange", "options", "isLightFilter", "className", "cardBordered", "editableUtils", "rootRef"],
...
function TableRender(props) {
  var _props$tableLayout, _props$columns, _props$editable, _props$editable2;
  ...
  var baseTableDom = /*#__PURE__*/_react.default.createElement(_antd.Table, _extends({}, getTableProps(), {
    rowKey: rowKey,
  ...
  var tableContentDom = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, toolbarDom, alertDom, props.editable ? /*#__PURE__*/_react.default.createElement(_proForm.default, _extends({}, (_props$editable = props.editable) === null || _props$editable === void 0 ? void 0 : _props$editable.formProps, {
    component: false,
  ...
  var tableAreaDom = cardProps === false ? tableContentDom : /*#__PURE__*/_react.default.createElement(_antd.Card, _extends({
...
var ProTable = function ProTable(props) {
  ...
  (0, _react.useMemo)(function () {
    ...
    if ((_action$dataSource = action.dataSource) === null || _action$dataSource === void 0 ? void 0 : _action$dataSource.length) {
      ...
      var keys = action.dataSource.map(function (data, index) {
        var dataRowKey = getRowKey(data, index);
  ...
  }, [propsColumns, counter, columnEmptyText, type, // eslint-disable-next-line react-hooks/exhaustive-deps
