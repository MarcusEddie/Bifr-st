...
function BetaSchemaForm(props) {
  ...
  var genItems = (0, _react.useCallback)(function (items, update) {
    ...
    return items.filter(function (originItem) {
      ...
      if (item.valueType === 'divider') {
        return /*#__PURE__*/_react.default.createElement(_antd.Divider, item.fieldProps);
      }
      /** 公用的 类型 props */
      ...
      return /*#__PURE__*/_react.default.createElement(_index.ProFormField, _extends({}, formFieldProps, {
        ...
        renderFormItem: (item === null || item === void 0 ? void 0 : item.renderFormItem) ? function (_, config) {
          ...
          var renderConfig = (0, _proUtils.omitUndefined)(_objectSpread(_objectSpread({}, config), {}, {
            onChange: undefined
          }));
  ...
  if (layoutType === 'StepsForm') {
    return /*#__PURE__*/_react.default.createElement(_index.StepsForm, _extends({
      formRef: formRef,
      form: form
    }, rest), steps === null || steps === void 0 ? void 0 : steps.map(function (item, index) {
      return /*#__PURE__*/_react.default.createElement(BetaSchemaForm, _extends({}, item, {
        key: index,
        layoutType: "StepForm",
  ...
  if (layoutType === 'Embed') return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, domList);
