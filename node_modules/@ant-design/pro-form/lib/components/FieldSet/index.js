  ...
  var list = (0, _toArray.default)(children).map(function (item) {
    if ( /*#__PURE__*/_react.default.isValidElement(item)) {
      ...
      return /*#__PURE__*/_react.default.cloneElement(item, _objectSpread(_objectSpread({
        ...
        fieldProps: _objectSpread(_objectSpread({}, item === null || item === void 0 ? void 0 : (_item$props = item.props) === null || _item$props === void 0 ? void 0 : _item$props.fieldProps), {}, {
          onChange: function onChange() {
            var _item$props2, _item$props2$fieldPro, _item$props2$fieldPro2, _item$props3, _item$props3$onChange;

            for (var _len = arguments.length, restParams = new Array(_len), _key = 0; _key < _len; _key++) {
              restParams[_key] = arguments[_key];
            }

            (_item$props2 = item.props) === null || _item$props2 === void 0 ? void 0 : (_item$props2$fieldPro = _item$props2.fieldProps) === null || _item$props2$fieldPro === void 0 ? void 0 : (_item$props2$fieldPro2 = _item$props2$fieldPro.onChange) === null || _item$props2$fieldPro2 === void 0 ? void 0 : _item$props2$fieldPro2.call.apply(_item$props2$fieldPro2, [_item$props2$fieldPro].concat(restParams));
            (_item$props3 = item.props) === null || _item$props3 === void 0 ? void 0 : (_item$props3$onChange = _item$props3.onChange) === null || _item$props3$onChange === void 0 ? void 0 : _item$props3$onChange.call.apply(_item$props3$onChange, [_item$props3].concat(restParams));
            fieldSetOnChange(restParams[0], index);
          }
        }),
        value: value[index],
        onChange: function onChange(itemValue) {
          var _item$props$onChange, _item$props4;

          fieldSetOnChange(itemValue, index);
          (_item$props$onChange = (_item$props4 = item.props).onChange) === null || _item$props$onChange === void 0 ? void 0 : _item$props$onChange.call(_item$props4, itemValue);
        }
      }));
    }
