...
var _excluded = ["children", "contentRender", "submitter", "fieldProps", "formItemProps", "groupProps", "dateFormatter", "form", "formRef", "onInit", "extraUrlParams", "syncToUrl", "syncToInitialValues", "onReset", "omitNil"],
    _excluded2 = ["request", "params", "initialValues"];
...
function BaseForm(props) {
  ...
  var transformKey = (0, _react.useCallback)(function (values, omit, parentKey) {
    return (0, _proUtils.transformKeySubmitValue)((0, _proUtils.conversionSubmitValue)(values, dateFormatter, fieldsValueType.current, omit, parentKey), transformKeyRef.current, omit);
  }, [dateFormatter]);
  ...
  }, [omitNil, transformKey]); // 初始化给一个默认的 form
  ...
  var submitterNode = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/_react.default.createElement(_Submitter.default, _extends({
      key: "submitter"
    }, submitterProps, {
  ...
  }, [extraUrlParams, form, loading, omitNil, _onReset, setUrlSearch, submitter, submitterProps, syncToUrl, transformKey, userForm]);
  ...
  (0, _react.useEffect)(function () {
    ...
    (0, _warning.noteOnce)(props.initialValues === preInitialValues, "initialValues \u53EA\u5728 form \u521D\u59CB\u5316\u65F6\u751F\u6548\uFF0C\u5982\u679C\u4F60\u9700\u8981\u5F02\u6B65\u52A0\u8F7D\u63A8\u8350\u4F7F\u7528 request\uFF0C\u6216\u8005 initialValues ? <Form/> : null ");
    (0, _warning.noteOnce)(props.initialValues === preInitialValues, "The initialValues only take effect when the form is initialized, if you need to load asynchronously recommended request, or the initialValues ? <Form/> : null ");
...
function RequestForm(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(BaseForm, _extends({
    autoComplete: "off"
  }, rest, {
