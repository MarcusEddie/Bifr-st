...
import { conversionSubmitValue, transformKeySubmitValue, useMountMergeState, ProFormContext, runFunction, useFetchData } from '@ant-design/pro-utils';
...
function BaseForm(props) {
  ...
  var transformKey = useCallback(function (values, omit, parentKey) {
    return transformKeySubmitValue(conversionSubmitValue(values, dateFormatter, fieldsValueType.current, omit, parentKey), transformKeyRef.current, omit);
  }, [dateFormatter]);
  ...
  useEffect(function () {
    ...
    noteOnce(props.initialValues === preInitialValues, "initialValues \u53EA\u5728 form \u521D\u59CB\u5316\u65F6\u751F\u6548\uFF0C\u5982\u679C\u4F60\u9700\u8981\u5F02\u6B65\u52A0\u8F7D\u63A8\u8350\u4F7F\u7528 request\uFF0C\u6216\u8005 initialValues ? <Form/> : null ");
    noteOnce(props.initialValues === preInitialValues, "The initialValues only take effect when the form is initialized, if you need to load asynchronously recommended request, or the initialValues ? <Form/> : null ");
