...
import AddUiCase from './components/AddUiCase';
  ...
  return (
    <PageContainer>
      <ProCard split="vertical">
        ...
        <ModalForm title={intl.formatMessage({ id: 'pages.uiTest.create.newCase', })} width="1000px" preserve={false} visible={createModalVisible} onVisibleChange={handleNewModalVisible}
          onFinish={async () => {
            return false;
          }}
          submitter={false}
        ...
        >
          <AddUiCase rowSelected={rowSelected}></AddUiCase>
        </ModalForm>
      </ProCard>
    </PageContainer>
  );
